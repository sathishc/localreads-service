...
grails.project.groupId = LocalReads // change this to alter the default package name and Maven publishing destination
...
environments {
    ...
    production {
        ...
        grails.serverURL = "https://www.microlibrary.co"
    }
}
...
log4j = {
    ...
    debug  'grails.app.com.squareprism'
}*/
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.squareprism.localreads.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.squareprism.localreads.UserRole'
grails.plugin.springsecurity.authority.className = 'com.squareprism.localreads.Role'
